...
const featureGroups = [
  ...
  },
  {
    ...
    description:
      'Burndown charts, velocity trends, and cycle time reports give leads a clear read on how sprints are actually going.',
  },
  {
    icon: 'ti-bell',
    iconColor: '#00A3FF',
    ...
    description:
      'Every update — status changes, comments, PR merges — propagates instantly across the workspace, no refresh needed.',
  },
  {
    ...
    description:
      'Granular access controls let you scope visibility by team, project, or workspace so the right people see the right things.',
  },
]
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-12 w-full">
        ...
        <p className="text-base text-gray-500 leading-relaxed max-w-[560px]">
          Explore the collaboration tools, planning workflows, and delivery insights that help
          teams move fast together.
        </p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20 w-full">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {featureGroups.map(({ icon, iconColor, title, description }) => (
            <div
              key={title}
